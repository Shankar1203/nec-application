...
const ToolSelectionArea = ({ tool, glueDatabases, IBM2GlueMigration, setGlueDatabases, T2MBmigration, createDate, taskName, setTaskName, file, setFile, setPage, T2Pmigration }) => {
    ...
    return (
        <div className='actionArea'>
            ...
            <ToolDetailsTemplate tool={tool} glueDatabases={glueDatabases} setGlueDatabases={setGlueDatabases} invalidName={invalidName} setInvalidName={setInvalidName} taskName={taskName} setTaskName={setTaskName} setPage={setPage} file={file} setFile={setFile} />
